	...
	LEFTMENUITEMS: Menu[] = [
		{
			path: '/', title: 'Home', type: 'sub', active: false, children: [
			  { path: 'home/#feature-arts', title: 'Feature Arts', type: 'link' },
			  { path: '/#latest-item', title: 'Latest Items', type: 'link' },
			  { path: '/#explore', title: 'Explore', type: 'link' },
			  { path: '/#popular-item', title: 'Popular Items', type: 'link' },
			  { path: '/#event', title: 'Events', type: 'link' }
			]
		},
		{
			path: '/pages/aboutus', title: 'About Us', type: 'link'
		...
		// {
		// 	title: 'home', type: 'sub', megaMenu: true, active: false, children: [
		// 	  {
